...
class TRMSudoku(nn.Module):
    """TRM-MLP for Sudoku: MLP-Mixer instead of attention (~5M params).
    ...
    - ff_hidden=1536 to match ~5M param target
    """
